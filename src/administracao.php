...
<div class="container-fluid mt-5">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="mb-3">
                ...
                <div class="d-grid gap-2" href="index.php?page=plistaprofiss">
                    <a href= "index.php?page=plistaprofiss" class="btn btn-primary mt-2">Pesquisar Terapeuta</a>
                </div>
            </div>
            <div>
            ...
            <ul class="list-group mt-3">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">Camily R. <span><button class="btn btn-primary btn-sm me-2"><svg xmlns="http://www.w3.org/2000/svg" height="23px" viewBox="0 -960 960 960" width="23px" fill="#FFFFFF"><path d="M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z"/></svg></button><button class="btn btn-danger btn-sm"><svg xmlns="http://www.w3.org/2000/svg" height="23px" viewBox="0 -960 960 960" width="23px" fill="#FFFFFF"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg></button></span></li>
                <li class="list-group-item d-flex justify-content-between align-items-center">Maria S. <span><button class="btn btn-primary btn-sm me-2">Editar</button><button class="btn btn-danger btn-sm">Apagar</button></span></li>
                <li class="list-group-item d-flex justify-content-between align-items-center">Carlos O. <span><button class="btn btn-primary btn-sm me-2">Editar</button><button class="btn btn-danger btn-sm">Apagar</button></span></li>
                <li class="list-group-item d-flex justify-content-between align-items-center">Fábio M. <span><button class="btn btn-primary btn-sm me-2">Editar</button><button class="btn btn-danger btn-sm">Apagar</button></span></li>
        ...
        <h2 class="mb-3">Materiais para Download</h2>
            ...
            <a href="server-info.php"><button type="button" class="btn btn-link disabled">Server Info</button></a>
        </div>
    </div>
</div>
