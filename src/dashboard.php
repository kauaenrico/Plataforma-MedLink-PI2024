                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-3">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="d-block user-select-none" width="200%" height="400" aria-label="Placeholder: Image cap" focusable="false" role="img" preserveAspectRatio="xMidYMid slice" viewBox="0 0 318 180" style="font-size:1.125rem;text-anchor:middle">
                                <rect width="200%" height="200%" fill="#868e96"></rect>
